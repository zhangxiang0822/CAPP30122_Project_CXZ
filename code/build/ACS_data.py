...
def query_poverty_data():
    '''
    This function queries information on poverty status. 
    Two main variables:
        - Number of individuals whose poverty status is determined
...
def query_education_data():
    '''
    This function queries information on education attainment
    '''  
    varlist = [
                "COUNTY", 
				"NAME", 
